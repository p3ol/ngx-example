...
export default class Premium {
  ...
  ngOnInit() {
    poool('event', 'onSubscribeClick', this.onSubscribeClick.bind(this));
    this.sendHit();
  }
  ...
  isUserPremium() {
    return window.testUser?.premium;
  }

  ngOnDestroy() {
    poool('unevent', 'onSubscribeClick', this.onSubscribeClick.bind(this));
    poool('flush');
  }
}
